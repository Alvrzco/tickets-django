...
def wassender(request):
   ...
   numeroconcat = "34" + numero
   print(numeroconcat)
   payload = {
    "phone": numeroconcat,
    "message": "Hola " + nombre + ". La reserva con ID *#" + ticket + "* ha sido confirmada. Tienes reservadas *" + entradas +"* entradas para *" + evento +* " asociadas al email " + email + ". Puedes recogerlas en bla bla.. Si no quieres recibir más avisos de reservas y darte de baja en nuestro sistema envíanos un /stop"
    }
   headers = {
    "Content-Type": "application/json",
    "Token": "5d886fb595293b7111b77a50e6ac00a7a84e14ee97800b0d8975273042efedfbbe84c87b8ba32bb3"
   }
   response = requests.request("POST", url, json=payload, headers=headers)
   print(response.text)
   return HttpResponse(request.POST['ticket'])
